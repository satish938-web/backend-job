    ...
    try {
        ...
        if (file) {
            try {
                ...
                // Continue without profile photo if Cloudinary is not configured
                profilePhotoUrl = "";
            }
        }
...
export const updateProfile = async (req, res) => {
    try {
        ...
        // Handle file upload (optional - for resume)
        const file = req.file;
        if (file) {
            try {
                const fileUri = getDataUri(file);
                ...
                console.log("Cloudinary upload failed:", cloudinaryError.message);
                // Continue without resume if Cloudinary is not configured
            }
        }
